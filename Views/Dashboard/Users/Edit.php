...
<div class="container">
    <div class="row">
        <div class="col-8 mx-auto bg-light my-5 border border-dark border-3">
            ...
            <form action="<?php echo URL . "/Controllers/Dash/User/Update.php?id=" . $user_id ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" id="username" value="<?= isset($username) ? $username : '' ?>" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" id="password" value="<?php echo $userpass ?>" class="form-control">

                    </div>
                    <div class="mb-3">
                        <input type="submit" name="Submit" value="Submit" class="btn btn-success">
                        <a href="<?php echo URL . '/Views/Dashboard/Users/Index.php'; ?>"
